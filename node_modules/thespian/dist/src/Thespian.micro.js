...
describe("Thespian()", () => {
    describe("object", () => {
        it("method called once", () => {
            ...
            const mock = thespian.mock("an object");
            mock
                .setup(f => f.foo(2, mismatched_1.match.ofType.string()))
                .returns(() => 44);
            (0, mismatched_1.assertThat)(mock.object.foo(2, "aaa")).is(44);
            thespian.verify();
        });
        ...
        it("a method called twice with same arguments", () => {
            ...
            mock
                ...
                .returns(() => 55);
            (0, mismatched_1.assertThat)(mock.object.foo(2, "aaa")).is(44);
            (0, mismatched_1.assertThat)(mock.object.foo(2, "aaa")).is(55);
            thespian.verify();
        });
        it("a method called twice with different arguments", () => {
            ...
            mock
                .setup(f => f.foo(3, "aaa"))
                .returns(() => 55);
            (0, mismatched_1.assertThat)(mock.object.foo(3, "aaa")).is(55);
            (0, mismatched_1.assertThat)(mock.object.foo(2, "aaa")).is(44);
            thespian.verify();
        });
        it("method called with no mock set up for it", () => {
            const thespian = new Thespian_1.Thespian();
            const mock = thespian.mock("anObject");
            (0, mismatched_1.assertThat)(() => mock.object.foo(2, "aaa")).throwsError(`{
  ...
  mockCall: anObject.foo()
        ...
        it("method called but arguments do not match", () => {
            ...
            mock
                .setup(f => f.foo(2, mismatched_1.match.ofType.string()))
                .returns(() => 44);
            (0, mismatched_1.assertThat)(() => mock.object.foo(4, "aaa")).throwsError(`{
  problem: "Unable to handle call, as none match", 
  mockCall: anObject.foo(4, "aaa"), 
  nearMisses: [
    {
      call: 
      anObject.foo({${mismatched_1.MatchResult.unexpected}: 4}, {${mismatched_1.MatchResult.expected}: 2}, "aaa"), 
      expectedTimes: 1, actualTimes: 0
        ...
        it("method called but arguments are not the same length", () => {
            ...
            mock
                .setup(f => f.goo(1, 2, 3))
                .returns(() => 44);
            (0, mismatched_1.assertThat)(() => mock.object.goo(1, 2)).throwsError(`{
  problem: "Unable to handle call, as none match", mockCall: anObject.goo(1, 2), 
  nearMisses: [
    {
      call: anObject.goo(1, 2, {${mismatched_1.MatchResult.expected}: 3}), expectedTimes: 1, 
      actualTimes: 0
    }
  ]
}`);
  ...
  nearMisses: [
    ...
    {
      call: 
      anObject.foo({${mismatched_1.MatchResult.unexpected}: 2}, {${mismatched_1.MatchResult.expected}: 3}, "aaa"), 
      expectedTimes: 1, actualTimes: 0
    }
  ], 
  previousSuccessfulCalls: [
    {call: anObject.foo(2, "aaa"), returnValue: 44, expectedTimes: 1}
        ...
        it("a method call partially matches two separate mock calls", () => {
            ...
            mock
                .setup(f => f.foo(3, "bbb"))
                .returns(() => 55);
            (0, mismatched_1.assertThat)(() => mock.object.foo(3, "aaa")).throwsError(`{
  problem: "Unable to handle call, as none match", 
  mockCall: anObject.foo(3, "aaa"), 
  nearMisses: [
    {
      call: 
      anObject.foo({${mismatched_1.MatchResult.unexpected}: 3}, {${mismatched_1.MatchResult.expected}: 2}, "aaa"), 
      expectedTimes: 1, actualTimes: 0
    }, 
    {
      call: 
      anObject.foo(3, {${mismatched_1.MatchResult.unexpected}: "aaa"}, {${mismatched_1.MatchResult.expected}: "bbb"}), 
      expectedTimes: 1, actualTimes: 0
    }
  ]
}`);
        ...
        it("Mocks are displayed correctly when in mismatched argument list", () => {
            mismatched_1.PrettyPrinter.make(80, 10, 10000, Thespian_1.Thespian.symbolForMockToString);
            const thespian = new Thespian_1.Thespian();
            const mockI = thespian.mock("i");
            mockI
                .setup(g => g.foo(2, "a"))
                .returns(() => 33);
            const i = mockI.object;
            const mockJ = thespian.mock("j");
            const j = mockJ.object;
            mockJ
                .setup(g => g.ga(j))
                .returns(arg => arg);
            (0, mismatched_1.assertThat)(() => j.ga(i)).throws(new Error(`{problem: "Unable to handle call, as none match", mockCall: j.ga({mock: "i"})}`));
        });
    });
    describe("function", () => {
        it("function called once", () => {
            let thespian = new Thespian_1.Thespian();
            let mock = thespian.mock("fn");
            mock
                .setup(g => g(2))
                .returns(() => 33);
            (0, mismatched_1.assertThat)(mock.object(2)).is(33);
            thespian.verify();
        });
        it("function called twice with same arguments and same result", () => {
            const thespian = new Thespian_1.Thespian();
            const mock = thespian.mock("fn");
            mock
                .setup(g => g(2))
                .returns(() => 33)
                .times(2);
        ...
        it("function called twice with same arguments and different result", () => {
            ...
            mock
                ...
                .returns(() => 44);
            (0, mismatched_1.assertThat)(mock.object(2)).is(33);
            (0, mismatched_1.assertThat)(mock.object(2)).is(44);
            thespian.verify();
        });
        it("function called twice with different arguments", () => {
            ...
            mock
                .setup(g => g(3))
                .returns(() => 44);
            (0, mismatched_1.assertThat)(mock.object(3)).is(44);
            (0, mismatched_1.assertThat)(mock.object(2)).is(33);
            thespian.verify();
        });
    });
    describe("property", () => {
        it("property accessed once", () => {
            ...
            mock
                .setup(f => f.prop)
                .returns(() => 44);
            (0, mismatched_1.assertThat)(mock.object.prop).is(44);
            thespian.verify();
        });
        ...
        it("property set up and accessed twice", () => {
            ...
            mock
                ...
                .returns(() => 55);
            (0, mismatched_1.assertThat)(mock.object.prop).is(44);
            (0, mismatched_1.assertThat)(mock.object.prop).is(55);
            thespian.verify();
        });
        it("property missing", () => {
            const thespian = new Thespian_1.Thespian();
            const mock = thespian.mock("anObject");
            (0, mismatched_1.assertThat)(() => mock.object.prop).throwsError(`{
  problem: "Unable to handle call or access property, as it has not been mocked", 
...
//# sourceMappingURL=Thespian.micro.js.map