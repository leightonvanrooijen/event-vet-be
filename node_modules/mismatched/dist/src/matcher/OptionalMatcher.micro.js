...
describe("OptionalMatcher:", () => {
    describe("assertThat():", () => {
        it("Matches", () => {
            (0, assertThat_1.assertThat)(3).is(match_1.match.optional(3));
            (0, assertThat_1.assertThat)(undefined).is(match_1.match.optional(3));
        });
        it("Mismatches", () => {
            (0, assertThat_1.assertThat)(4).failsWith(match_1.match.optional(3), { [MatchResult_1.MatchResult.was]: 4, [MatchResult_1.MatchResult.expected]: 3 });
        });
        it("Mismatches: errors", () => {
            const mismatched = [];
            const matcher = match_1.match.optional(3);
    ...
    describe("validateThat():", () => {
        const expected = { f: match_1.match.optional(match_1.match.ofType.number()) };
        it("succeeds", () => {
...
//# sourceMappingURL=OptionalMatcher.micro.js.map