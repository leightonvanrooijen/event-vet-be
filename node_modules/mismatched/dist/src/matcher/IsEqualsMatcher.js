...
exports.IsEqualsMatcher = void 0;
const DiffMatcher_1 = require("./DiffMatcher");
const MatchResult_1 = require("../MatchResult");
const Mismatched_1 = require("./Mismatched");
class IsEqualsMatcher extends DiffMatcher_1.DiffMatcher {
    ...
    describe() {
        return MatchResult_1.MatchResult.describe(this.expected);
    }
    static make(expected) {
        return new IsEqualsMatcher(expected);
    }
}
exports.IsEqualsMatcher = IsEqualsMatcher;
//# sourceMappingURL=IsEqualsMatcher.js.map